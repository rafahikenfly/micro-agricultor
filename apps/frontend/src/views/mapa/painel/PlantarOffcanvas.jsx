...
export default function PlantarOffcanvas({ show, data = {}, onClose, onConfirm, onCancel }) {
  ...
  useEffect(() => {
    //TODO: NA ABERTURA DO COMPONENTE, ESSTÁ RODANDO ESSE EFFECT E TIRANDO A SELECAO DA VARIEDADE
    if (!especie.id || !variedades.length) return;
