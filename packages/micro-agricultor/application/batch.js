...
export function aplicarRegraPorBatch({
  ...
  try {
    ...
    switch(results.operacao) {
      // Fluxo de aplicação de regra de criação de uma entidade
      // se não há o argumento entidade, é porque a regra cria. Logo,
      // só existe results.entidade e faz o create da entidade.
      case "CREATE":
