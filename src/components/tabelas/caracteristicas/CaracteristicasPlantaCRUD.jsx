...
import { caracteristicasPlantaService } from "../../../services/crud/caracteristicasPlantasService";
...
function CaracteristicasPlantasCRUD({ user }) {
  ...
  /* ================= CARREGAR DADOS ================= */
  useEffect(() => {
    const unsub = caracteristicasPlantaService.subscribe(setCaracteristicasPlanta);
    return unsub;
  }, []);
  ...
  const {
    ...
    crudService: caracteristicasPlantaService,
    nomeEntidade: "característica de planta",
...
export default CaracteristicasPlantasCRUD;